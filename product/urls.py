...
urlpatterns = [
    ...
    path('stock/create/', StockInCreateView.as_view(), name='stock_in_create'),
    path('stock/select-department/', DepartmentSelectView.as_view(), name='stock_in_add'),
    ...
    path('employee-stock/', EmployeeListView.as_view(), name='employee_list'),
    path('employees/<int:employee_id>/stock/', EmployeeStockDetailView.as_view(), name='employee_stock_detail'),
    ]
